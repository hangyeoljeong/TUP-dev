  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ color: '#FF6B35' }}>TUP!</span>은 공모전 참가자들을 위한 지능형 팀 매칭
          플랫폼입니다.
          <br />
        ...
        >
          ...
          >
            ...
            >
              <EmojiEventsIcon
                style={{ fontSize: '2.5rem', color: '#FF6B35', marginRight: '15px' }}
              />
              <h3
                style={{
                  fontSize: '1.5rem',
          ...
          >
            ...
            >
              ...
              >
                기술 스택, 관심사, 경험을 기반으로 최적의 팀원을 찾습니다
              </p>
            </div>
            <div
              style={{
            ...
            >
              ...
              >
                다양한 공모전 정보를 한눈에 확인하고 팀을 바로 구성하세요
              </p>
            </div>
          </div>
        </div>
